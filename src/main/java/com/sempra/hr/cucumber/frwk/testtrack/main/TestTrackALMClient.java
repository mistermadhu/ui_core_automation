	...
	public long createAndUpdateTestRun(TestCaseInfo tcdObj) {
		try {
			...
			if (lngCookie > 0) {
				 ...
				 ***************************************************************************************/
				objTTTestRun = objTT.editTestRunByRecordID(lngCookie, testRunID, false);// .editTestRun(lngCookie,
																						// testRunID,
																						// "Updated
																						// by
																						// ui
																						// framework",
																						// false);//.editTestRunByRecordID(lngCookie,
																						// testRunID,
																						// false);////.getTestRun(lngCookie,
																						// strNewTestRunID,
																						// "Updated
																						// by
																						// ui
...
*/
	 ...
	 * String url="https://sempra.seapine.net/scripts/ttsoapcgi.exe"; // Replace
	 * FrameworkConstants.ALM_URL with this string TestCaseInfo trdObj=new
	 * TestCaseInfo();
